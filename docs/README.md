...
| [Ses Yükseltici (Volume Booster)](kullanim/ses-booster.md) | Sekme sesini %500'e kadar çıkarma (Alt+Shift+↑/↓) |
| [Çoklu Yayın (Multistream)](kullanim/coklu-yayin.md) | Birden fazla Kick yayınını tek ekranda izleme |
| [Yan Yana Görünüm ve Cep Yayın (PiP)](kullanim/split-view-pip.md) | İki sekmeyi yan yana; yayını köşede oynatma |
| [Stabilite ve Performans](kullanim/stabilite.md) | Otomatik çökme kurtarma, bellek tasarrufu, video kararlılığı |
